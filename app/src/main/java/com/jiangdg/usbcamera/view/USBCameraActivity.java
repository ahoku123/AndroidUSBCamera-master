   ...
   //     for (String str : permissions) {
    ...
    private void getDiskInfo() {
        ...
        try {
            ...
            Log.e(TAG,"isUsb::"+isUsb.toString());
            Log.e(TAG,"isSd::"+isSd.toString());
            //VolumeInfo
            //VolumeInfo
            ...
            for(int i= 0 ;i<volumeInfoList.size();i++){
                ...
                //showShortMsg("volumeInfoList.get("+i+"):"+volumeInfoList.get(i).toString());
...
//                    Log.e("willie","sdcard path_path::"+path.invoke(volumeInfoList.get(i)));
                ...
                //    showShortMsg("sdcard:"+path_sdcard);
                    Log.e(TAG,"fsUuid::"+fsUuid.invoke(volumeInfoList.get(i)));
                } else{
            ...
            case R.id.menu_recording:
                ...
                if (!mCameraHelper.isPushing()) {
                   ...
                   //         + UVCCameraHelper.SUFFIX_MP4;
                    String videoPath = "/dev/bus/usb/001/009" +"/videos/"+ System.currentTimeMillis();
                   // String videoPath = "/mnt/media_rw/2D38-13E7/videos/" + "test";
                    //String videoPath = "/storage/2D38-13E7" +"/videos/" + System.currentTimeMillis();
